...
class FuresoeExplorerApp:
    ...
    def run(self):
        ...
        self.selected_language = st.sidebar.selectbox("Sprog/Language", ("Danish", "English"))
        self.navigation = st.sidebar.radio("Navigate to:", ("Map", "Wildlife", "History", "Guides", "Useful Info",))

        title_eng = "Explore Furesø - Wildlife, History, and More"
        title_dk = "Udforsk Furesø - Dyreliv, Historie og Mere"
        st.title(f"""{title_eng if self.selected_language == 'English' else title_dk}""")
